...
export default function JoinGame() {
	...
	return (
		<div className="grid grid-cols-1 items-center content-stretch gap-4 place-items-center">
			...
			<div className="items-center mb-6"><Button as={Link} to={game_type ? "/game/pong" : "/game/breakout"} className="w-48 h-24 neon-btn neon-btn-light tracking-neon text-xs sm:text-base rounded-lg">{t("menu.join_game")}</Button></div>
		</div>
  );
}
