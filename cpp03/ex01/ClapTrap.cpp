...
/*   Updated: 2025/08/25 03:20:48 by bcaumont         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
	std::cout << RED "Default constructor called.\033[0m" << std::endl;
}

ClapTrap::ClapTrap(const std::string &name) : name(name), hitPoints(100),
