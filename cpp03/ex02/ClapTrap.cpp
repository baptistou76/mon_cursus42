...
/*   Updated: 2025/08/27 00:58:59 by bcaumont         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
	std::cout << RED "ClapTrap default constructor called.\033[0m" << std::endl;
}
...
{
	std::cout << RED "ClapTrap copy constructor called.\033[0m" << std::endl;
	*this = copy;
}

ClapTrap &ClapTrap::operator=(const ClapTrap &copy)
{
	std::cout << RED "ClapTrap assignment operator called\033[0m" << std::endl;
	if (this != &copy)
	{
		this->name = copy.name;
...
ClapTrap::~ClapTrap()
{
	std::cout << RED "ClapTrap destructor called\033[0m" << std::endl;
}
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	if (hitPoints <= 0)
	{
		std::cout << name << " is already destroy." << std::endl;
		return ;
	}
	hitPoints -= amount;
	if (hitPoints < 0)
		hitPoints = 0;
	std::cout << name << " takes " << amount << " points of damage! (HP left: " << hitPoints << ")" << std::endl;
}
